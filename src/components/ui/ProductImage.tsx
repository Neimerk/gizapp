...
export default function ProductImage({ imageUrl, alt, category = "", className = "", containerClassName = "" }: Props) {
  ...
  if (error || !imageUrl) {
    return (
      <div
        className={`flex items-center justify-center bg-gradient-to-br ${palette} ${containerClassName}`}
      >
