  ...
  return (
    <div className="mt-6 flex flex-col items-center gap-3 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div className="flex items-center gap-1">
        <PageBtn onClick={() => onPageChange(page - 1)} disabled={page === 1} aria-label="Anterior">
          <ChevronLeft size={15} />
        </PageBtn>
        ...
        <PageBtn onClick={() => onPageChange(page + 1)} disabled={page === totalPages} aria-label="Próxima">
...
function PageBtn({
  children, onClick, active, disabled, "aria-label": ariaLabel,
}: {
