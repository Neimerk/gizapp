  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8">
      ...
      <div className="mb-8">
        <Link
          to="/"
          className="mb-4 inline-flex items-center gap-1.5 text-sm font-bold text-[#64748b] hover:text-[#0f172a]"
        >
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <h1 className="text-2xl font-black text-[#0f172a]">Lojas em destaque</h1>
          </div>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="rounded-3xl border-2 border-dashed border-[#e2e8f0] bg-white p-16 text-center">
          ...
          <p className="font-black text-[#0f172a]">Nenhuma loja em destaque ainda</p>
          <p className="mt-1 text-sm text-[#64748b]">As lojas parceiras aparecerão aqui em breve.</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
